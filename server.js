...
const template = require('./scripts/tpl.js');
import Vue from 'vue';
...
// const funzionarioArticolo = async function(req, res) {
...
// 		}
// 	});
// 	res.send(await template.generate('info.html', app));
// }

// app.get("/funzionario-articolo.html", funzionarioArticolo);

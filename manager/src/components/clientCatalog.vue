...
<div class="container-fluid p-2">
  <div  v-for="user in catalog" :key="user._id">
    <div class="d-flex justify-content-center align-items-center">
      <div class="card mt-1 mb-1 w-100" style="height: 10em; width:90%; ">
        <div class="card-body h-100 w-100">
          <div class="row h-100">
            ...
            <div class="col-8 p-2 text-truncate" style="height:100%;"> <h2>  <router-link  tabindex="0" :aria-label="'link a cliente' + user.email" :to="{name: 'client', params:{email: user.email}}" >{{user.userName + ' ' + user.userSurname}}</router-link></h2>

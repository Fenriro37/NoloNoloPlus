      ...
      <div class="card mb-1" style="height: 10em; width:60%; ">
        <div class="card-body h-100">
          <div class="row h-100">
            ...
            <div class="col-8 text-truncate" style="height:100%;"> <h2>  <router-link @click.native="switchComponent" :to="{name: 'client', params:{id: user._id}}" >{{user.userName + ' ' + user.userSurname}}</router-link></h2>

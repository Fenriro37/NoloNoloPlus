        ...
        <form>
          <fieldset disabled={!this.state.boolModifying} >
            <Form.Group className="mb-2" controlId="formBasicText">
              ...
              <Form.Control type="text" placeholder={this.state.userName} aria-label="Username" aria-describedby="basic-addon1"/>
            </Form.Group>   

            <Form.Group className="mb-2" controlId="formBasicText">
              <Form.Label>User Surname:</Form.Label>
              <Form.Control type="text" placeholder={this.state.userSurname} />
            </Form.Group>    
            ...
            <Form.Group as={Col} className="mb-2" controlId="formBasicText">
              <Form.Label>User Birthday:</Form.Label>
              <Form.Control type="date" placeholder={new Date(this.state.userBirthday.year, this.state.userBirthday.month, this.state.userBirthday.day)} />
            </Form.Group>
            ...
            <Row>
              <Form.Group as={Col} xs={8} className="mb-2" controlId="formBasicText">
                <Form.Label>Address Street:</Form.Label>
                <Form.Control type="text" placeholder={this.state.userAddress.street} />
              </Form.Group>

              <Form.Group as={Col} xs={4} className="mb-2" controlId="formBasicText">
            ...
            <Form.Group className="mt-1 mb-2" controlId="formBasicText">
            ...
            <Row>
              ...
              <Col xs={4}>
                <Form.Select className="mb-2 ml-0" 
          ...
          <Button type="button" onClick={this.save} variant={this.state.boolModifying ? "success" : "primary"}>
